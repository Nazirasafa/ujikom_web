...
<body>
    ...
    <section class="container py-5" id="school-profile">
        <h2 class="text-center mb-4">School Profile</h2>
        <div class="row">
            <div class="col-md-6">
                <img src="assets/images/smk.jpeg" alt="School Building" class="img-fluid w-75 rounded">
            </div>
            <div class="col-md-6">
    ...
    <section class="container py-5" id="gallery">
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <img src="gallery1.jpg" alt="Gallery 1" class="img-fluid">
            </div>
            <div class="col-md-4 mb-4">
                <img src="gallery2.jpg" alt="Gallery 2" class="img-fluid">
            </div>
            <div class="col-md-4 mb-4">
                <img src="gallery3.jpg" alt="Gallery 3" class="img-fluid">
            </div>
        </div>
    </section>
    ...
    <section class="container py-5" id="news">
        <h2 class="text-center mb-4">School News</h2>
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Brief news description goes here. Lorem ipsum dolor sit amet.</p>
